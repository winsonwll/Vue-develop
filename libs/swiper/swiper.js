...
var Swiper = function(a, b) {
    ...
    function p(a) {
        ...
        if (!Z || 1 === a.targetTouches.length) {
            ...
            C.touches.startX = C.touches.currentX = e, C.touches.startY = C.touches.currentY = f, 
            C.touches.start = C.touches.current = M ? e : f, C.setWrapperTransition(0), C.positions.start = C.positions.current = C.getWrapperTranslate(), 
    ...
    function u(a, c, d) {
        function e() {
            ...
            h += i * l / (1e3 / 60), k = "toNext" === j ? h > a : a > h, k ? (C.setWrapperTranslate(Math.ceil(h)), 
        ...
        C.init = function(a, c) {
            ...
            if (d !== C.width || e !== C.height || a) {
                ...
                m.style.height = j + "px", E = M ? i : j; else {
                    ...
                    for (f = M ? C.width / b.slidesPerView : C.width, b.roundLengths && (f = Math.ceil(f)), 
                    ...
                    C.slidesGrid.push(k), k += E, parseFloat(f) > 0 && (!b.cssWidthAndHeight || "height" === b.cssWidthAndHeight) && (C.slides[l].style.width = f + "px"), 
...
Swiper.prototype = {
    ...
    wrapperTransitionEnd: function(a, b) {
        "use strict";
        function c(h) {
            if (h.target === f && (a(e), e.params.queueEndCallbacks && (e._queueEndCallbacks = !1), 
            !b)) for (d = 0; d < g.length; d++) e.h.removeEventListener(f, g[d], c);
        }
...
"function" == typeof define && define.cmd && define("lib/swiper", [], function() {
    "use strict";
    return Swiper;
});